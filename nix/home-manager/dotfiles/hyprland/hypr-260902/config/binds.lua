...
hl.bind("ALT + SHIFT + " .. digitCode(1),     hl.dsp.window.move({ monitor = MONITOR1 }))
hl.bind("ALT + SHIFT + " .. digitCode(2),     hl.dsp.window.move({ monitor = MONITOR2 }))
hl.bind("ALT + SHIFT + " .. digitCode(3),     hl.dsp.window.move({ monitor = MONITOR3 }))
--<!!>
...
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd(SHOT_SCREEN))
...
hl.bind("ALT + " .. digitCode(1), hl.dsp.focus({ monitor = MONITOR1 }))
hl.bind("ALT + " .. digitCode(2), hl.dsp.focus({ monitor = MONITOR2 }))
hl.bind("ALT + " .. digitCode(3), hl.dsp.focus({ monitor = MONITOR3 }))
...
hl.bind(mainMod .. " + SLASH",        hl.dsp.focus({ workspace = "emptym" }))
